...
/**
 * Servlet implementation class ExcUpdate
 */
@WebServlet("/member/todayExcUpdate")
public class ExcUpdate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result=new StatisticService().excUpdate(memberId);
		String msg="";
		String loc="";
		if(result>0) {
			msg="업데이트 성공"	;	
